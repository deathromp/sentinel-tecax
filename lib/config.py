...
def get_dash_conf():
    ...
    dash_conf = os.path.join(home, ".tecaxcore/tecax.conf")
    if sys.platform == 'darwin':
        dash_conf = os.path.join(home, "Library/Application Support/TecaxCore/tecax.conf")

    dash_conf = sentinel_cfg.get('tecax.conf', dash_conf)
